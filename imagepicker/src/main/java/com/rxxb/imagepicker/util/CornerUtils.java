...
public class CornerUtils {
    ...
    public static StateListDrawable btnSelector(float radius, int normalColor, int pressColor, int enableColor, int position) {
        ...
        if (position == 0) {// left btn
            ...
            enabled = cornerDrawable(enableColor, new float[]{0, 0, 0, 0, 0, 0, radius, radius});
        } else if (position == 1) {// right btn
            ...
            enabled = cornerDrawable(enableColor, new float[]{0, 0, 0, 0, radius, radius, 0, 0});
        } else if (position == -1) {// only one btn
            ...
            enabled = cornerDrawable(enableColor, new float[]{0, 0, 0, 0, radius, radius, radius, radius});
        } else if (position == -2) {// for material dialog
