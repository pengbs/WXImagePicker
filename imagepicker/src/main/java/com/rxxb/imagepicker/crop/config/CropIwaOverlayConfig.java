...
public class CropIwaOverlayConfig {
    ...
    public static CropIwaOverlayConfig createDefault(Context context) {
        ...
        CropIwaOverlayConfig config = new CropIwaOverlayConfig()
                .setBorderColor(r.color(com.rxxb.imagepicker.R.color.cropiwa_default_border_color))
                .setCornerColor(r.color(com.rxxb.imagepicker.R.color.cropiwa_default_corner_color))
                .setGridColor(r.color(com.rxxb.imagepicker.R.color.cropiwa_default_grid_color))
                .setOverlayColor(r.color(com.rxxb.imagepicker.R.color.cropiwa_default_overlay_color))
                .setBorderStrokeWidth(r.dimen(com.rxxb.imagepicker.R.dimen.cropiwa_default_border_stroke_width))
                .setCornerStrokeWidth(r.dimen(com.rxxb.imagepicker.R.dimen.cropiwa_default_corner_stroke_width))
                .setCropScale(DEFAULT_CROP_SCALE)
                .setGridStrokeWidth(r.dimen(com.rxxb.imagepicker.R.dimen.cropiwa_default_grid_stroke_width))
                .setMinWidth(r.dimen(com.rxxb.imagepicker.R.dimen.cropiwa_default_min_width))
                .setMinHeight(r.dimen(com.rxxb.imagepicker.R.dimen.cropiwa_default_min_height))
    ...
    public static CropIwaOverlayConfig createFromAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.rxxb.imagepicker.R.styleable.CropIwaView);
        try {
            c.setMinWidth(ta.getDimensionPixelSize(
                    com.rxxb.imagepicker.R.styleable.CropIwaView_ci_min_crop_width,
                    c.getMinWidth()));
            c.setMinHeight(ta.getDimensionPixelSize(
                    com.rxxb.imagepicker.R.styleable.CropIwaView_ci_min_crop_height,
                    c.getMinHeight()));
            c.setAspectRatio(new AspectRatio(
                    ta.getInteger(com.rxxb.imagepicker.R.styleable.CropIwaView_ci_aspect_ratio_w, 1),
                    ta.getInteger(com.rxxb.imagepicker.R.styleable.CropIwaView_ci_aspect_ratio_h, 1)));
            c.setCropScale(ta.getFloat(
                    com.rxxb.imagepicker.R.styleable.CropIwaView_ci_crop_scale,
                    c.getCropScale()));
            c.setBorderColor(ta.getColor(
                    com.rxxb.imagepicker.R.styleable.CropIwaView_ci_border_color,
                    c.getBorderColor()));
            c.setBorderStrokeWidth(ta.getDimensionPixelSize(
                    com.rxxb.imagepicker.R.styleable.CropIwaView_ci_border_width,
                    c.getBorderStrokeWidth()));
            c.setCornerColor(ta.getColor(
                    com.rxxb.imagepicker.R.styleable.CropIwaView_ci_corner_color,
                    c.getCornerColor()));
            c.setCornerStrokeWidth(ta.getDimensionPixelSize(
                    com.rxxb.imagepicker.R.styleable.CropIwaView_ci_corner_width,
                    c.getCornerStrokeWidth()));
            c.setGridColor(ta.getColor(
                    com.rxxb.imagepicker.R.styleable.CropIwaView_ci_grid_color,
                    c.getGridColor()));
            c.setGridStrokeWidth(ta.getDimensionPixelSize(
                    com.rxxb.imagepicker.R.styleable.CropIwaView_ci_grid_width,
                    c.getGridStrokeWidth()));
            c.setShouldDrawGrid(ta.getBoolean(
                    com.rxxb.imagepicker.R.styleable.CropIwaView_ci_draw_grid,
                    c.shouldDrawGrid()));
            c.setOverlayColor(ta.getColor(
                    com.rxxb.imagepicker.R.styleable.CropIwaView_ci_overlay_color,
                    c.getOverlayColor()));
            c.setCropShape(ta.getInt(com.rxxb.imagepicker.R.styleable.CropIwaView_ci_crop_shape, 0) == 0 ?
                    new CropIwaRectShape(c) :
                    new CropIwaOvalShape(c));
            c.setDynamicCrop(ta.getBoolean(
                    com.rxxb.imagepicker.R.styleable.CropIwaView_ci_dynamic_aspect_ratio,
                    c.isDynamicCrop()));
        } finally {
            ta.recycle();
        }
