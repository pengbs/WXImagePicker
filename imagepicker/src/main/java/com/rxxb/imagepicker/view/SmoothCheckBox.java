...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private Paint mPaint, mTickPaint, mFloorPaint, mTextPaint;
    ...
    private void drawText(Canvas canvas) {
        int fontSize = mCenterPoint.x;
        mTextPaint.setTextSize(fontSize);
        canvas.drawText("23", mCenterPoint.x, mCenterPoint.y - ((mTextPaint.descent() + mTextPaint.ascent()) / 2), mTextPaint);
    }
