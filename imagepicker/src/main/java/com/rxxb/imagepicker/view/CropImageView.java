...
public class CropImageView extends AppCompatImageView {
    ...
    public CropImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.rxxb.imagepicker.R.styleable.CropImageView);
        mMaskColor = a.getColor(com.rxxb.imagepicker.R.styleable.CropImageView_cropMaskColor, mMaskColor);
        mBorderColor = a.getColor(com.rxxb.imagepicker.R.styleable.CropImageView_cropBorderColor, mBorderColor);
        mBorderWidth = a.getDimensionPixelSize(com.rxxb.imagepicker.R.styleable.CropImageView_cropBorderWidth, mBorderWidth);
        mFocusWidth = a.getDimensionPixelSize(com.rxxb.imagepicker.R.styleable.CropImageView_cropFocusWidth, mFocusWidth);
        mFocusHeight = a.getDimensionPixelSize(com.rxxb.imagepicker.R.styleable.CropImageView_cropFocusHeight, mFocusHeight);
        mDefaultStyleIndex = a.getInteger(com.rxxb.imagepicker.R.styleable.CropImageView_cropStyle, mDefaultStyleIndex);
