package com.rxxb.imagepickerdemo;
...
import com.rxxb.imagepickerdemo.imageloader.GlideImageLoader;
...
public class ImagePickerActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_type0 = (Button) findViewById(R.id.btn_type0);
        btn_type0.setOnClickListener(this);
        Button btn_type1 = (Button) findViewById(R.id.btn_type1);
        btn_type1.setOnClickListener(this);
        Button btn_type1_mu = (Button) findViewById(R.id.btn_type1_mu);
        btn_type1_mu.setOnClickListener(this);
